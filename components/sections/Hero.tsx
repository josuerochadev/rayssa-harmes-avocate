...
import { Calendar, Mail, Shield, Clock, Users, Star } from 'lucide-react'
          ...
          <div className="animate-on-scroll">
            <div className="mb-6">
              ...
              <div className="text-sm text-gray-600 font-medium">
                Zone d&apos;intervention : Strasbourg et région
              </div>
            </div>
            
            <h1 className="mb-6 animate-fade-in">
              <span className="block text-primary">Avocate à Strasbourg</span>
              <span className="block text-2xl md:text-3xl lg:text-4xl font-normal text-gray-700 mt-2">
                Contrats • Famille • Étrangers • Travail • Immobilier
              </span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Conseil & contentieux avec rendez-vous rapide, écoute et clarté. 
              Accompagnement personnalisé pour défendre vos droits et vos intérêts.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>Écoute personnalisée</span>
              </div>
            </div>
