      ...
      <div className="card p-6 h-full transition-all duration-300 hover:shadow-xl hover:scale-105">
        <div className="flex flex-col h-full">
          <div className="flex items-center space-x-4 mb-4">
            <div className="bg-secondary p-3 rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
              <Icon className="h-6 w-6 text-primary group-hover:text-white transition-colors" />
            </div>
            <h3 className="font-slab font-semibold text-xl text-primary group-hover:text-accent transition-colors">
              {title}
            </h3>
          </div>
